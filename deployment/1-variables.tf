variable "aws_region" {
  ...
  type        = string
  default     = "us-west-2" # Your AWS region
}
...
variable "vpc_availability_zones" {
  ...
  type        = list(string)
  default     = ["us-west-2a", "us-west-2b"] # Two availability zones for your specific region
}
...
variable "bastion_host_cidr" {
  ...
  type        = string
  default     = "104.32.0.0/14" # Your <IP address>/32
}
...
variable "dev_api_server_domain" {
  ...
  type        = string
  default     = "api.dev.joybackend.online"
}
