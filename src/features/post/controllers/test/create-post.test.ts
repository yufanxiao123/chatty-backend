...
/**
 * a method in JavaScript that allows you to add properties to an object and define their attributes
 * @param object
 * @param collection of property and their attributes
 * example:
 * let obj = {};
    ...
    console.log(obj.property2); // "Hello, world!"
 */
//use this to see socketIOPostObject.emit('add post',createdPost); is called
